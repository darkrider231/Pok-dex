...
// The getPokemonData function makes an Axios Get request to the PokeAPI using the specific pokemon ID/Number, then takes the returned data and passes it into the createPokeCard function
async function getPokmonData(id){
